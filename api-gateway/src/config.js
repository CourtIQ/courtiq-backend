const services = [
    ...
    { name: 'matchup', url: process.env.MATCHUP_SERVICE_URL || 'http://matchup-service:8082/query' },
    { name: 'string', url: process.env.STRING_SERVICE_URL || 'http://string-service:8083/query' },
