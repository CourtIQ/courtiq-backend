...
func (r *userResolver) MyTennisRackets(ctx context.Context, obj *model.User, limit *int, offset *int, federationRequires map[string]interface{}) ([]*model.TennisRacket, error) {
...
func (r *userResolver) MyTennisStrings(ctx context.Context, obj *model.User, limit *int, offset *int, federationRequires map[string]interface{}) ([]*model.TennisString, error) {
