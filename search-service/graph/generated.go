...
import (
	...
	"github.com/CourtIQ/courtiq-backend/search-service/graph/scalar"
...
type ComplexityRoot struct {
	Query struct {
		SearchHealth       func(childComplexity int) int
...
type QueryResolver interface {
	SearchHealth(ctx context.Context) (bool, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.searchHealth":
		if e.complexity.Query.SearchHealth == nil {
			break
		}

		return e.complexity.Query.SearchHealth(childComplexity), true
...
//go:embed "schema/queries/SearchHealth.gql" "schema/types/Search.gql"
...
var sources = []*ast.Source{
	{Name: "schema/queries/SearchHealth.gql", Input: sourceData("schema/queries/SearchHealth.gql"), BuiltIn: false},
	{Name: "schema/types/Search.gql", Input: sourceData("schema/types/Search.gql"), BuiltIn: false},
...
func (ec *executionContext) _Query_searchHealth(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_searchHealth(ctx, field)
	if err != nil {
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return ec.resolvers.Query().SearchHealth(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_searchHealth(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) fieldContext_Search_id(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Search",
		Field:      field,
		IsMethod:   false,
	...
	for i, field := range fields {
		...
		case "searchHealth":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_searchHealth(ctx, field)
				if res == graphql.Null {
